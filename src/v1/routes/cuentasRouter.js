...
router
  ...
  .post('/updateEstado/:id', cuentasController.updateEstado)                 // Actualizar el estado de la cuenta
  .post('/updateMetodoPago/:id', cuentasController.updateMetodoPago)         //Actualizar el metodo de pago
